...
class _PropertyDetailsState extends State<PropertyDetails> {
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Align(
                  alignment: Alignment.topLeft,
                  child: Text(
                    "Boufarik, Wilaya de Blida, Algerie",
                    style: TextStyle(
                        color: Colors.black54,
                        fontSize: 12,
                        fontWeight: FontWeight.w400,
        ...
        Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Icon(
                Icons.wifi,
                color: commodite.wifi ? Constants.redAirbnb : Colors.grey,
              )
            ],
          ),
        ),
        ...
        Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Icon(
                Icons.pool,
                color: commodite.piscine ? Constants.redAirbnb : Colors.grey,
              )
            ],
          ),
        ),
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Icon(
                ...
                color: commodite.gym ? Constants.redAirbnb : Colors.grey,
              )
            ],
          ),
        ),
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Icon(
                Icons.room_service,
                color:
                    commodite.repasInclus ? Constants.redAirbnb : Colors.grey,
              )
            ],
          ),
        ),
        ...
        Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Icon(
                Icons.local_parking,
                color: commodite.Parking ? Constants.redAirbnb : Colors.grey,
              )
            ],
          ),
        ),
        Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Icon(
                Icons.widgets,
                color: commodite.equipe ? Constants.redAirbnb : Colors.grey,
              )
            ],
          ),
        ),
  ...
  buildDescreption(BuildContext context) {
    return Padding(
      ...
      child: Text(
        "Quiet, carefully designed & furnished apartement",
        style: TextStyle(
          fontSize: 20,
          color: Colors.black,
        ),
