                ...
                Center(
                  child: Column(
                    children: [
                      ...
                      //       ),
                      //       child: Text("Confirm and pay now",style: TextStyle(color: Colors.white),textAlign: TextAlign.center,)),
                      // ),
                          ...
                          children: [
                            ...
                            TextButton(
                              ...
                              child: Stack(
                                children: [
                                  Image(
                                    image: AssetImage('assets/wf.jpg'),
                                    width: 50.0,
                                    height: 50.0,
                                  ),
                                ],
                            ...
                            TextButton(
                              ...
                              child: Stack(
                                children: [
                                  Image(
                                    image: AssetImage('assets/dmoney.jpg'),
                                    width: 50.0,
                                    height: 50.0,
                                  ),
                                ],
